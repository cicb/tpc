...
class Ventas extends CActiveRecord
{
    ...
    public function getTotalCortesias($id,$desde,$hasta,$eventoId="",$funcionId=""){
        $query = "";
    ...
    public function getVentasDetalleIndividual($eventoId,$funcionId,$zonaId,$usuarioId,$desde,$hasta){
        $data=Yii::app()->db->createCommand("SELECT  ventaslevel1.EventoId, ventaslevel1.FuncionesId, ventaslevel1.ZonasId,
                                             ...
                                             (ventaslevel1.VentasSta = 'VENDIDO') AND
                                             (ventaslevel1.VentasBolTip = 'NORMAL') AND ventaslevel1.DescuentosId =0 AND
                                             (ventas.VentasFecHor BETWEEN '$desde 00:00:00' AND '$hasta 23:59:00') ")->queryAll();
        return new CArrayDataProvider($data, array(
                            'pagination'=>false,
			));
