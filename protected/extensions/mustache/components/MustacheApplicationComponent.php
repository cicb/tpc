...
class MustacheApplicationComponent extends CApplicationComponent {
	...
	public function render($templateName, $view=null, $partialNames=null, $options=null,$forceOutput=true)
	{
		$partials = null;
		...
		$output= $this->m->render($this->getTemplate($templateName), $view, $partials, $options);
	      if($forceOutput){
		  echo $output;
	      }
		  return $output;
