<div class="controles">
    ...
    <div class='span4' style="float:none;display:block;margin:auto;">
            <div class="row">
                Taquilleros:
                <?php
                $modeloUsuarios = Usuarios::model()->findAll(array('condition' => "TipUsrId IN(1,3)",'order'=>'	UsuariosNom'));
...
<div class="corte-diario" id="corte">
<?php if(!empty($eventos)): ?>
     ...
     <br /> <br />  
        <table class="table table-bordered">
            ...
            <tfoot>
                ...
                <tr>
                    <?php $cortesias = $model->getTotalCortesias($_POST['usuario_id'],$_POST['desde'],$_POST['hasta'],$evento['EventoId'],$evento['FuncionesId']);
        ...
        <table class="table span2" style="border: 1px solid black;float: left;">
            <tbody>
                <?php
    ...
    <?php
      ...
      $cortesia = $model->getTotalCortesias($_POST['usuario_id'],$_POST['desde'],$_POST['hasta']);
...
$("a#boton-show-info").click(function(){
    ...
    //if(cargado==0){
        ...
        $.ajax({
            ...
            data   : {eventoId:eventoId,funcionId:funcionId,desde:desde,hasta:hasta},
            type   : 'post',
