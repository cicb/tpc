     ...
     //print_r($boleto);
        ?>
            <div style="position:relative;margin-left: 10px; margin-top: 33px;width: 75mm;height: 160mm; font-size: 7pt;">
                ...
                <div style=" position: absolute;top:<?php echo $formato[26]->FormatoY-25; ?>px ;left:<?php echo $formato[26]->FormatoX-30;?>px ;<?php echo $formato[26]->FormatoVisible=="true"?"":"display:none;"; ?>text-align:center;"> <?php Barcode::getCodigo($boleto['LugaresNumBol']."0");//$this->widget('application.extensions.cbarras.CBarras',array('text'=>$boleto['LugaresNumBol'],'size'=>30));?><br /> <?php echo $boleto['LugaresNumBol']; ?></div>                                                                                                                                                                                                                                      
            </div> 
        <?php
