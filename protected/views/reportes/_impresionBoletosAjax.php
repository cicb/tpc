...
$this->widget('application.extensions.cbarras.CBarras',array('code_string'=>$boleto['LugaresNumBol'],'size'=>5));?><br /> <?php echo $boleto['LugaresNumBol']; ?></div>                                                                                                                                                                                                                                      
        ...
        ?>
            <?php
                ...
                <div style="border: none solid 1px; width: 83px;text-align: left; position: absolute;top:<?php echo $formato[6]->FormatoY+26; ?>px ;left:<?php echo $formato[6]->FormatoX;?>px ;<?php echo $formato[6]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['VentasBolTip']; ?></div>
                ...
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[8]->FormatoY+26; ?>px ;left:<?php echo $formato[8]->FormatoX;?>px ;<?php echo $formato[8]->FormatoVisible=="true"?"":"display:none;"; ?>width: 90px;height: 40px;"> <?php echo substr($boleto['VentasCon'],0,15)."<br/>".substr($boleto['VentasCon'],15,20); ?></div>
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[9]->FormatoY+36; ?>px ;left:<?php echo $formato[9]->FormatoX;?>px ;<?php echo $formato[9]->FormatoVisible=="true"?"":"display:none;"; ?>width: 90px;height: 40px;"> <?php echo substr($boleto['VentasCon'],0,15)."<br/>".substr($boleto['VentasCon'],15,20); ?></div>
                ...
                <div style="border: none solid 1px; width: 80px;text-align: center; position: absolute;top:<?php echo $formato[11]->FormatoY+26; ?>px ;left:<?php echo $formato[11]->FormatoX;?>px ;<?php echo $formato[11]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".number_format($boleto['cosBol']); ?></div>
                ...
                <div style="border: none solid 1px; width: 110px;text-align: center; position: absolute;top:<?php echo $formato[14]->FormatoY+26; ?>px ;left:<?php echo $formato[14]->FormatoX+15;?>px ;<?php echo $formato[14]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['ZonasAli']." ".$concat; ?></div>
                ...
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[17]->FormatoY+26; ?>px ;left:<?php echo $formato[17]->FormatoX;?>px ;<?php echo $formato[17]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $filasAli ; ?></div>
                ...
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[20]->FormatoY+26; ?>px ;left:<?php echo $formato[20]->FormatoX;?>px ;<?php echo $formato[20]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['LugaresLug']; ?></div>
                ...
                <div style="border: none solid 1px; width: 95px;text-align: center; position: absolute;top:<?php echo $formato[23]->FormatoY+26; ?>px ;left:<?php echo $formato[23]->FormatoX;?>px ;<?php echo $formato[23]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".substr($boleto['VentasCarSer'],0,-3); ?></div>
                ...
                <div style="width: 75mm;height: 69px; text-align: center; border: none solid 1px; position: absolute;top:<?php echo $formato[25]->FormatoY-22; ?>px ;left:<?php echo $formato[25]->FormatoX-10;?>px ;<?php echo $formato[25]->FormatoVisible=="true"?"":"display:none;"; ?>"><?php echo  CHtml::image ( ($boleto['EventoImaBol']==""?"http://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/".Yii::app ()->baseUrl . '/imagesbd/blanco.jpg':"http://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/". Yii::app ()->baseUrl . '/imagesbd/'.$boleto['EventoImaBol']) , '', array () ); ?> </div>
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[26]->FormatoY-2; ?>px ;left:<?php echo $formato[26]->FormatoX-25;?>px ;<?php echo $formato[26]->FormatoVisible=="true"?"":"display:none;"; ?>text-align:center;"> <?php /*Barcode::getCodigo($boleto['LugaresNumBol']."0");*/ $this->widget('application.extensions.cbarras.CBarras',array('code_string'=>$boleto['LugaresNumBol'],'size'=>3,'code_type'=>'ean13','htmlOptions'=>array('style'=>'height:55px;width:200px')));?><br /> <?php echo substr($boleto['LugaresNumBol'],0,6); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo substr($boleto['LugaresNumBol'],6,12); ?></div>     
            </div> 
        <?php
        ...
        ?>
            <?php
                ...
                ?>
            <div style="margin-bottom: 110px;position:relative;border: none solid 1px;width: 77mm;height: 168mm; font-size: 9pt;font-weight: bold; font-family: Arial;">
            
                <div style="border: none solid 1px; width: 48px;text-align: center; position: absolute;top:<?php echo $formato[0]->FormatoY-10; ?>px ;left:<?php echo $formato[0]->FormatoX;?>px ;<?php echo $formato[0]->FormatoVisible=="true"?"":"display:none;"; ?>text-align:center;font-size: 7pt;">Acceso</div>
                <div style="border: none solid 1px; width: 48px;text-align: center; position: absolute;top:<?php echo $formato[0]->FormatoY; ?>px ;left:<?php echo $formato[0]->FormatoX;?>px ;<?php echo $formato[0]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['SubzonaAcc']; ?></div> 
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[1]->FormatoY+32; ?>px ;left:<?php echo $formato[1]->FormatoX;?>px ;<?php echo $formato[1]->FormatoVisible=="true"?"":"display:none;"; ?>width: 70mm;text-align:center;font-size: 10pt;"> <?php echo $boleto['EventoDesBol']; ?></div>
                ...
                <div style="border: none solid 1px; width: 83px;text-align: left; position: absolute;top:<?php echo $formato[5]->FormatoY-8; ?>px ;left:<?php echo $formato[5]->FormatoX-10;?>px ;<?php echo $formato[5]->FormatoVisible=="true"?"":"display:none;"; ?>font-size: 7pt;">Tipo</div>
                <div style="border: none solid 1px; width: 83px;text-align: left; position: absolute;top:<?php echo $formato[5]->FormatoY+2; ?>px ;left:<?php echo $formato[5]->FormatoX-10;?>px ;<?php echo $formato[5]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['VentasBolTip'];  ?></div>
                <div style="border: none solid 1px; width: 83px;text-align: left; position: absolute;top:<?php echo $formato[6]->FormatoY+65; ?>px ;left:<?php echo $formato[6]->FormatoX-10;?>px ;<?php echo $formato[6]->FormatoVisible=="true"?"":"display:none;"; ?>font-size: 7pt;"> Tipo</div>
                ...
                <div style="border: none solid 1px; width: 83px;text-align: left; position: absolute;top:<?php echo $formato[7]->FormatoY+70; ?>px ;left:<?php echo $formato[7]->FormatoX-10;?>px ;<?php echo $formato[7]->FormatoVisible=="true"?"":"display:none;"; ?>font-size: 7pt;">Tipo</div>
                ...
                <div style="border: none solid 1px; width: 80px;text-align: center; position: absolute;top:<?php echo $formato[10]->FormatoY+2; ?>px ;left:<?php echo $formato[10]->FormatoX+10;?>px ;<?php echo $formato[10]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".number_format($boleto['cosBol']); ?></div>       
                ...
                <div style="border: none solid 1px; width: 80px;text-align: center; position: absolute;top:<?php echo $formato[12]->FormatoY+50; ?>px ;left:<?php echo $formato[12]->FormatoX;?>px ;<?php echo $formato[12]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".number_format($boleto['cosBol']); ?></div>
                <div style="border: none solid 1px; width: 130px;text-align: center; position: absolute;top:<?php echo $formato[13]->FormatoY; ?>px ;left:<?php echo $formato[13]->FormatoX+15;?>px ;<?php echo $formato[13]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['ZonasAli']." ".$concat; ?></div>
                ...
                <div style="border: none solid 1px; width: 130px;text-align: center; position: absolute;top:<?php echo $formato[15]->FormatoY+50; ?>px ;left:<?php echo $formato[15]->FormatoX;?>px ;<?php echo $formato[15]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['ZonasAli']." ".$concat; ?></div>
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[16]->FormatoY; ?>px ;left:<?php echo $formato[16]->FormatoX+15;?>px ;<?php echo $formato[16]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $filasAli; ?></div>
                ...
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[18]->FormatoY+50; ?>px ;left:<?php echo $formato[18]->FormatoX+5;?>px ;<?php echo $formato[18]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $filasAli; ?></div>
                <div style="border: none solid 1px; width: 30px;text-align: center; position: absolute;top:<?php echo $formato[19]->FormatoY; ?>px ;left:<?php echo $formato[19]->FormatoX+35;?>px ;<?php echo $formato[19]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['LugaresLug']; ?></div>
                ...
                <div style="border: none solid 1px; width: 30px;text-align: center; position: absolute;top:<?php echo $formato[21]->FormatoY+50; ?>px ;left:<?php echo $formato[21]->FormatoX+35;?>px ;<?php echo $formato[21]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['LugaresLug']; ?></div>
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[22]->FormatoY+2; ?>px ;left:<?php echo $formato[22]->FormatoX+30;?>px ;<?php echo $formato[22]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".substr($boleto['VentasCarSer'],0,-3); ?></div>
                ...
                <div style="border: none solid 1px; width: 95px;text-align: center; position: absolute;top:<?php echo $formato[24]->FormatoY+50; ?>px ;left:<?php echo $formato[24]->FormatoX;?>px ;<?php echo $formato[24]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".substr($boleto['VentasCarSer'],0,-3); ?></div>
                <div style="border: none solid 1px; width: 75mm;height: 69px; text-align: center; position: absolute;top:<?php echo $formato[25]->FormatoY+3; ?>px ;left:<?php echo $formato[25]->FormatoX-8;?>px ;<?php echo $formato[25]->FormatoVisible=="true"?"":"display:none;"; ?>"><?php echo  CHtml::image ( ($boleto['EventoImaBol']==""?"http://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/".Yii::app ()->baseUrl . '/imagesbd/blanco.jpg':"http://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/". Yii::app ()->baseUrl . '/imagesbd/'.$boleto['EventoImaBol']) , '', array () ); ?> </div>
                <div style="border: none solid 1px; width: 75mm;height: 69px; text-align: center; position: absolute;top:<?php echo $formato[26]->FormatoY+1; ?>px ;left:<?php echo $formato[26]->FormatoX-78;?>px ;<?php echo $formato[26]->FormatoVisible=="true"?"":"display:none;"; ?>text-align:center;"> <?php /*Barcode::getCodigo($boleto['LugaresNumBol']."0");*/ $this->widget('application.extensions.cbarras.CBarras',array('code_string'=>$boleto['LugaresNumBol'],'size'=>3,'code_type'=>'ean13','htmlOptions'=>array('style'=>'height:55px;width:200px')));?><br /> <?php echo substr($boleto['LugaresNumBol'],0,6); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo substr($boleto['LugaresNumBol'],6,12); ?></div>     
            </div> 
        <?php
       }      
