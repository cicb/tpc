     ...
     //print_r($boleto);
        ?>
            <div style="position:relative;border: none;width: 75mm;height: 160mm; font-size: 7pt;">
                ...
                <div style=" position: absolute;top:<?php echo $formato[26]->FormatoY; ?>px ;left:<?php echo $formato[26]->FormatoX;?>px ;<?php echo $formato[26]->FormatoVisible=="true"?"":"display:none;"; ?>text-align:center;"> <?php Barcode::getCodigo($boleto['LugaresNumBol']);//$this->widget('application.extensions.cbarras.CBarras',array('text'=>$boleto['LugaresNumBol'],'size'=>30));?><br /> <?php echo $boleto['LugaresNumBol']; ?></div>                                                                                                                                                                                                                                      
            </div> 
        <?php
