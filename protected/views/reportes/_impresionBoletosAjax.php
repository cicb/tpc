       ...
       if($formato[0]->FormatoId=="1"){
        ...
        ?>
            <div style="position:relative;border: white solid 1px;width: 75mm;height: 180mm; font-size: 9pt;font-weight: bold;">
                ...
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[26]->FormatoY+5; ?>px ;left:<?php echo $formato[26]->FormatoX-25;?>px ;<?php echo $formato[26]->FormatoVisible=="true"?"":"display:none;"; ?>text-align:center;"> <?php Barcode::getCodigo($boleto['LugaresNumBol']."0");//$this->widget('application.extensions.cbarras.CBarras',array('text'=>$boleto['LugaresNumBol'],'size'=>30));?><br /> <?php echo $boleto['LugaresNumBol']; ?></div>                                                                                                                                                                                                                                      
            </div> 
        <?php
       }   
