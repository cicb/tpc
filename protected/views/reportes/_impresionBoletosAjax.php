       ...
       if($formato[0]->FormatoId=="1"){
        ?>
            ...
            <div style="position:relative;border: none solid 1px;width: 75mm;height: 180mm; font-size: 9pt;font-weight: bold;">
                ...
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[8]->FormatoY+47; ?>px ;left:<?php echo $formato[8]->FormatoX-2;?>px ;<?php echo $formato[8]->FormatoVisible=="true"?"":"display:none;"; ?>width: 50px;height: 40px;"> <?php echo substr($boleto['VentasCon'],0,15)."<br/>".substr($boleto['VentasCon'],15,15); ?></div>
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[9]->FormatoY+38; ?>px ;left:<?php echo $formato[9]->FormatoX-2;?>px ;<?php echo $formato[9]->FormatoVisible=="true"?"":"display:none;"; ?>width: 50px;height: 40px;"> <?php echo substr($boleto['VentasCon'],0,15)."<br/>".substr($boleto['VentasCon'],15,15); ?></div>
...
$this->widget('application.extensions.cbarras.CBarras',array('code_string'=>$boleto['LugaresNumBol'],'size'=>5));?><br /> <?php echo $boleto['LugaresNumBol']; ?></div>                                                                                                                                                                                                                                      
        ...
        ?>
            <div style="position:relative;border: white solid 1px;width: 75mm;height: 180mm; font-size: 9pt;font-weight: bold;">
                ...
                ?>
                <div style="border: none solid 1px; width: 48px;text-align: center; position: absolute;top:<?php echo $formato[0]->FormatoY+40; ?>px ;left:<?php echo $formato[0]->FormatoX;?>px ;<?php echo $formato[0]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['SubzonaAcc']; ?></div> 
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[1]->FormatoY+8; ?>px ;left:<?php echo $formato[1]->FormatoX;?>px ;<?php echo $formato[1]->FormatoVisible=="true"?"":"display:none;"; ?>width: 70mm;text-align:center;font-size: 11pt;"> <?php echo $boleto['EventoDesBol']; ?></div>
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[2]->FormatoY+28; ?>px ;left:<?php echo $formato[2]->FormatoX;?>px ;<?php echo $formato[2]->FormatoVisible=="true"?"":"display:none;"; ?>width: 70mm;text-align:center;font-size: 12pt;"> <?php echo $boleto['EventoNom']; ?></div>
                ...
                <div style="border: none solid 1px; width: 83px;text-align: left; position: absolute;top:<?php echo $formato[5]->FormatoY+10; ?>px ;left:<?php echo $formato[5]->FormatoX;?>px ;<?php echo $formato[5]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['VentasBolTip'];  ?></div>
                <div style="border: none solid 1px; width: 83px;text-align: left; position: absolute;top:<?php echo $formato[6]->FormatoY+28; ?>px ;left:<?php echo $formato[6]->FormatoX;?>px ;<?php echo $formato[6]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['VentasBolTip']; ?></div>
                <div style="border: none solid 1px; width: 83px;text-align: left; position: absolute;top:<?php echo $formato[7]->FormatoY+28; ?>px ;left:<?php echo $formato[7]->FormatoX;?>px ;<?php echo $formato[7]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['VentasBolTip']; ?></div>
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[8]->FormatoY+28; ?>px ;left:<?php echo $formato[8]->FormatoX;?>px ;<?php echo $formato[8]->FormatoVisible=="true"?"":"display:none;"; ?>width: 50px;height: 40px;"> <?php echo substr($boleto['VentasCon'],0,15)."<br/>".substr($boleto['VentasCon'],15,15); ?></div>
                <div style="border: none solid 1px; position: absolute;top:<?php echo $formato[9]->FormatoY+28; ?>px ;left:<?php echo $formato[9]->FormatoX;?>px ;<?php echo $formato[9]->FormatoVisible=="true"?"":"display:none;"; ?>width: 50px;height: 40px;"> <?php echo substr($boleto['VentasCon'],0,15)."<br/>".substr($boleto['VentasCon'],15,15); ?></div>
                <div style="border: none solid 1px; width: 80px;text-align: center; position: absolute;top:<?php echo $formato[10]->FormatoY+10; ?>px ;left:<?php echo $formato[10]->FormatoX;?>px ;<?php echo $formato[10]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".substr($boleto['cosBol'],0,-3); ?></div>       
                <div style="border: none solid 1px; width: 80px;text-align: center; position: absolute;top:<?php echo $formato[11]->FormatoY+28; ?>px ;left:<?php echo $formato[11]->FormatoX;?>px ;<?php echo $formato[11]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".substr($boleto['cosBol'],0,-3); ?></div>
                <div style="border: none solid 1px; width: 80px;text-align: center; position: absolute;top:<?php echo $formato[12]->FormatoY+28; ?>px ;left:<?php echo $formato[12]->FormatoX;?>px ;<?php echo $formato[12]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".substr($boleto['cosBol'],0,-3); ?></div>
                ...
                <div style="border: none solid 1px; width: 130px;text-align: center; position: absolute;top:<?php echo $formato[14]->FormatoY+28; ?>px ;left:<?php echo $formato[14]->FormatoX;?>px ;<?php echo $formato[14]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['ZonasAli']; ?></div>
                <div style="border: none solid 1px; width: 130px;text-align: center; position: absolute;top:<?php echo $formato[15]->FormatoY+28; ?>px ;left:<?php echo $formato[15]->FormatoX;?>px ;<?php echo $formato[15]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['ZonasAli']; ?></div>
                ...
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[17]->FormatoY+28; ?>px ;left:<?php echo $formato[17]->FormatoX;?>px ;<?php echo $formato[17]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['FilasAli']; ?></div>
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[18]->FormatoY+28; ?>px ;left:<?php echo $formato[18]->FormatoX;?>px ;<?php echo $formato[18]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['FilasAli']; ?></div>
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[19]->FormatoY; ?>px ;left:<?php echo $formato[19]->FormatoX;?>px ;<?php echo $formato[19]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['LugaresLug']; ?></div>
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[20]->FormatoY+28; ?>px ;left:<?php echo $formato[20]->FormatoX;?>px ;<?php echo $formato[20]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['LugaresLug']; ?></div>
                <div style="border: none solid 1px; width: 50px;text-align: center; position: absolute;top:<?php echo $formato[21]->FormatoY+28; ?>px ;left:<?php echo $formato[21]->FormatoX;?>px ;<?php echo $formato[21]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo $boleto['LugaresLug']; ?></div>
                <div style="border: none solid 1px; width: 95px;text-align: center; position: absolute;top:<?php echo $formato[22]->FormatoY+10; ?>px ;left:<?php echo $formato[22]->FormatoX;?>px ;<?php echo $formato[22]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".substr($boleto['VentasCarSer'],0,-3); ?></div>
                <div style="border: none solid 1px; width: 95px;text-align: center; position: absolute;top:<?php echo $formato[23]->FormatoY+28; ?>px ;left:<?php echo $formato[23]->FormatoX;?>px ;<?php echo $formato[23]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".substr($boleto['VentasCarSer'],0,-3); ?></div>
                <div style="border: none solid 1px; width: 95px;text-align: center; position: absolute;top:<?php echo $formato[24]->FormatoY+28; ?>px ;left:<?php echo $formato[24]->FormatoX;?>px ;<?php echo $formato[24]->FormatoVisible=="true"?"":"display:none;"; ?>"> <?php echo "$".substr($boleto['VentasCarSer'],0,-3); ?></div>
                <div style="width: 75mm;height: 69px; text-align: center; border: none solid 1px; position: absolute;top:<?php echo $formato[25]->FormatoY-15; ?>px ;left:<?php echo $formato[25]->FormatoX-10;?>px ;<?php echo $formato[25]->FormatoVisible=="true"?"":"display:none;"; ?>"><?php echo  CHtml::image ( ($boleto['EventoImaBol']==""?"http://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/".Yii::app ()->baseUrl . '/imagesbd/blanco.jpg':"http://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/". Yii::app ()->baseUrl . '/imagesbd/'.$boleto['EventoImaBol']) , '', array () ); ?> </div>
				<div style="border: none solid 1px; position: absolute;top:<?php echo $formato[26]->FormatoY+5; ?>px ;left:<?php echo $formato[26]->FormatoX-35;?>px ;<?php echo $formato[26]->FormatoVisible=="true"?"":"display:none;"; ?>text-align:center;"> <?php
 //Barcode::getCodigo($boleto['LugaresNumBol']."0");
 $this->widget('application.extensions.cbarras.CBarras',array('code_string'=>$boleto['LugaresNumBol'],'size'=>3,'code_type'=>'ean13',
'htmlOptions'=>array(
//'style'=>'height:25px;width:100px'
)));?><br /> <?php echo $boleto['LugaresNumBol']; ?></div>                                                                                                                                                                                                                                      
            </div> 
        <?php
       }   
