...
$this->widget('application.extensions.cbarras.CBarras',array('code_string'=>$boleto['LugaresNumBol'],'size'=>5));?><br /> <?php echo $boleto['LugaresNumBol']; ?></div>                                                                                                                                                                                                                                      
        ...
        ?>
            ...
            <div style="margin-bottom: 110px;position:relative;border: white solid 1px;width: 75mm;height: 168mm; font-size: 9pt;font-weight: bold; font-family: Arial;">
				...
				<div style="border: none solid 1px; position: absolute;top:<?php echo $formato[26]->FormatoY+5; ?>px ;left:<?php echo $formato[26]->FormatoX-25;?>px ;<?php echo $formato[26]->FormatoVisible=="true"?"":"display:none;"; ?>text-align:center;"> <?php
