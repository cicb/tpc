       ...
       if($formato[0]->FormatoId=="1"){
        ?>
            <div style="position:relative;border: none solid 1px;width: 75mm;height: 180mm; font-size: 9pt;font-weight: bold;">
                ...
                <div style="width: 70mm;height: 60px; text-align: center; border: none solid 1px; position: absolute;top:<?php echo $formato[25]->FormatoY+40; ?>px ;left:<?php echo $formato[25]->FormatoX;?>px ;<?php echo $formato[25]->FormatoVisible=="true"?"":"display:none;"; ?>"><?php echo  CHtml::image ( ($boleto['EventoImaBol']==""?$_SERVER["DOCUMENT_ROOT"].'/'. Yii::app ()->baseUrl . '/imagesbd/blanco.jpg':'..' . Yii::app ()->baseUrl . '/imagesbd/'.$boleto['EventoImaBol']) , '', array () ); ?> </div>
        ...
        ?>
            <div style="position:relative;border: white solid 1px;width: 75mm;height: 180mm; font-size: 9pt;font-weight: bold;">
                ...
                <div style="width: 70mm;height: 60px; text-align: center; border: white solid 1px; position: absolute;top:<?php echo $formato[25]->FormatoY+40; ?>px ;left:<?php echo $formato[25]->FormatoX;?>px ;<?php echo $formato[25]->FormatoVisible=="true"?"":"display:none;"; ?>"><?php echo  CHtml::image ( ($boleto['EventoImaBol']==""?$_SERVER["DOCUMENT_ROOT"].'/'. Yii::app ()->baseUrl . '/imagesbd/blanco.jpg':'..' . Yii::app ()->baseUrl . '/imagesbd/'.$boleto['EventoImaBol']) , '', array () ); ?> </div>
