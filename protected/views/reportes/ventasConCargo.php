        ...
        foreach ($evento->funciones as $funcion) {
            foreach ($funcion->zonas as $zona) {
                ...
                $this->widget('bootstrap.widgets.TbGridView', array(
                    ...
                    'dataProvider'=>$model->getDetallesZonasCargo($eventoId,$funcionesId,$zona->ZonasId,$desde,$hasta,$cargo='SI'),
                    'summaryText'=>'',
...
<?php
    $taquillas=$this->widget('bootstrap.widgets.TbGridView', array(
        'id'=>'taquilla-grid',
        'emptyText'=>'No se encontraron coincidencias',
        'dataProvider'=>$model->getReporteTaquilla($eventoId,$funcionesId,$desde,$hasta,$cargo='SI'),
        'summaryText'=>'',
        'columns'=>array(
            array(
...
?>
    ...
    $puntos=$this->widget('bootstrap.widgets.TbGridView', array(
        ...
        'emptyText'=>'No se encontraron coincidencias',
        'dataProvider'=>$model->getReporte($eventoId,$funcionesId,$desde,$hasta,$cargo='SI'),
        'summaryText'=>'',
