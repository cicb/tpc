...
$("#select-sub-zona-mapa-grande").change(function(){
    ...
    if(zona!="" && subzona!=""){
        ...
        $.ajax({
            url:'<?php echo $this->createUrl('evento/getCoordenadaMapaGrande') ?>',
            type:'post',
            dataType:'json',
            beforeSend:function(){
...
$("#ver-coordenadas-mapa-grande").click(function(){
    ...
    var funcionId = $("#coor-funcionid").attr('data-funcionId');
    $.ajax({
        url:'<?php echo $this->createUrl('evento/getCoordenadasMapaGrande') ?>',
            type:'post',
            dataType:'json',
            beforeSend:function(){
                $("#cargando-grande").html("Cargando Coordenadas");
...
$("#guardar-coordenada-mapa-grande").click(function(){
    ...
    if(zona!="" && subzona!=""){
        $.ajax({
                url:'<?php echo $this->createUrl('evento/guardarCoordenadasMapaGrande') ?>',
                type:'post',
                dataType:'json',
                beforeSend:function(){
...
$("#eliminar-coordenada-mapa-grande").click(function(){
    ...
    if(zona!="" && subzona!=""){
        ...
        if (del == true) {
            $.ajax({
                url:'<?php echo $this->createUrl('evento/deleteCoordenadaMapaGrande') ?>',
                type:'post',
                beforeSend:function(){
